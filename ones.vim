...
if lightline#colorscheme#background() ==# 'light'
  ...
  let s:p.inactive.left   = [ [ s:gray1,  s:gray2 ], [ s:gray1, s:bg ] ]
  let s:p.inactive.middle = [ [ s:gray1, s:gray2 ] ]
  let s:p.inactive.right  = [ [ s:gray1, s:gray2 ] ]

  " let s:p.inactive.left   = [ [ s:bg,  s:green ], [ s:gray1, s:bg ] ]
  " let s:p.inactive.middle = [ [ s:fg, s:gray2 ] ]
  " let s:p.inactive.right  = [ [ s:bg, s:green ] ]
endif
...
let g:lightline#colorscheme#ones#palette = lightline#colorscheme#flatten(s:p)
